...
public class WaveView extends View {
    ...
    //    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#ff29b042");
//    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#FF8adb8e");
...
//    private static final float DEFAULT_AMPLITUDE_RATIO = 0.05f;
    private static final float DEFAULT_AMPLITUDE_RATIO = 0.3f;
    ...
    private void createShader() {
        ...
        //mWaveShader = new BitmapShader(adjustPhotoRotation(bitmap,180), Shader.TileMode.REPEAT, Shader.TileMode.CLAMP);
