 ...
 * @param <ItemType>
 */
public abstract class BaseListAdapter<ItemType, Holder extends BaseListAdapter.ViewHolder> extends BaseAdapter {
     ...
     */
    public BaseListAdapter(Context context, int[]... itemTypes) {
     ...
     * @param item       当前的数据对象
     */
    protected abstract void bindView(int position, Holder viewHolder, @NonNull ItemType item);
